...
public class ModelGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
    ...
    ///// <summary>
    ///// Determines whether the user is Run.
    ///// </summary>
    ///// <returns><c>true</c> if the user is running; otherwise, <c>false</c>.</returns>
    ...
    public void UserDetected(long userId, int userIndex)
	{
        ...
        manager.DetectGesture(userId, KinectGestures.Gestures.Move);

        if (gestureInfo != null)
		{
			gestureInfo.text = "Realiza el movimiento";
            Debug.Log("Realiza el movimiento");
		}
	}
